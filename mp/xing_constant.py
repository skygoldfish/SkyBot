...
# 업종별 투자자별 매매현황
BM_FIELDS = ["tjjcode", "tjjtime", "msvolume", "mdvolume", "msvol", 
    "p_msvol", "msvalue", "mdvalue", "msval", "p_msval", "upcode"
]
...
# 해외선물 체결
OVC_FIELDS = ["symbol", "ovsdate", "kordate", "trdtm", "kortm", "curpr", 
    "ydiffpr", "ydiffSign", "open", "high", "low", "chgrate", "trdq", "totq", 
