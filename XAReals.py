...
class K3_(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        result['전일대비'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "change"))
        result['등락율'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "drate"))
        ...
        result['체결량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "cvolume"))
        result['누적거래량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "volume"))
        result['누적거래대금'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "value"))
        result['매도누적체결량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume"))
        result['매도누적체결건수'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdchecnt"))
        result['매수누적체결량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume"))
        result['매수누적체결건수'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mschecnt"))
        result['체결강도'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "cpower"))
        result['가중평균가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "w_avrg"))
        result['매도호가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerho"))
        result['매수호가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidho"))
        result['장정보'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "status")
        result['전일동시간대거래량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "jnilvolume"))
        result['단축코드'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "shcode")
        result['tr_code'] = szTrCode
...
class SC0(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        # result['주문가격'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ordprice"))
        ...
        # result['프로그램호가구분'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "pgmtype"))
        # result['공매도호가구분'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "gmhogagb"))
        # result['공매도가능여부'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "gmhogayn"))
        ...
        # result['포트폴리오번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "prtno"))
        # result['바스켓번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "basketno"))
        # result['트렌치번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "trchno"))
        # result['아아템번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "itemno"))
        # result['차입구분'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "brwmgmyn"))
        # result['회원사번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mbrno"))
        ...
        # result['모주문번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "prntordno"))
        # result['관리사원번호'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "mgempno")
        # result['원주문미체결수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "orgordundrqty"))
        # result['원주문정정수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "orgordmdfyqty"))
        # result['원주문취소수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ordordcancelqty"))
        # result['비회원사송신번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "nmcpysndno"))
        # result['주문금액'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ordamt"))
        # result['매매구분'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "bnstp")
        # result['예비주문번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "spareordno"))
        # result['반대매매일련번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "cvrgseqno"))
        # result['예약주문번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "rsvordno"))
        # result['복수주문일련번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mtordseqno"))
        # result['예비주문수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "spareordqty"))
        # result['주문사원번호'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "orduserid")
        # result['실물주문수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "spotordqty"))
        # result['재사용주문수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ordruseqty"))
        # result['현금주문금액'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mnyordamt"))
        # result['주문대용금액'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ordsubstamt"))
        # result['재사용주문금액'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ruseordamt"))
        # result['수수료주문금액'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ordcmsnamt"))
        # result['사용신용담보재사용금'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "crdtuseamt"))
        ...
        # result['매입금액'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "pchsamt"))
...
class NWS(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            ...
            result['BODY길이'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bodysize"))
            result['tr_code'] = szTrCode
...
class FC0(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            ...
            #result['매수누적체결건수'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mschecnt"))
            #result['체결강도'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "cpower"))
            #result['매도호가1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerho1"))
            #result['매수호가1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidho1"))
            result['미결제약정수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "openyak"))
            result['KOSPI200지수'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "k200jisu")
            #result['이론가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "theoryprice"))
            #result['괴리율'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "kasis"))
            #result['시장BASIS'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "sbasis"))
            #result['이론BASIS'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ibasis"))
            result['미결제약정증감'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "openyakcha"))
...
class NC0(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            ...
            result['미결제약정증감'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "openyakcha"))
            #result['장운영정보'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "jgubun")
            # result['미사용filler'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "jnilvolume"))
            result['단축코드'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "futcode")
            result['tr_code'] = szTrCode
...
class FH0(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            ...
            #result['매도호가1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerho1"))
            #result['매수호가1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidho1"))
            #result['매도호가수량1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerrem1"))
            #result['매수호가수량1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidrem1"))
            #result['매도호가건수1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offercnt1"))
            #result['매수호가건수1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidcnt1"))
            #result['매도호가2'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerho2"))
            #result['매수호가2'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidho2"))
            #result['매도호가수량2'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerrem2"))
            #result['매수호가수량2'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidrem2"))
            #result['매도호가건수2'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offercnt2"))
            #result['매수호가건수2'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidcnt2"))
            #result['매도호가3'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerho3"))
            #result['매수호가3'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidho3"))
            #result['매도호가수량3'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerrem3"))
            #result['매수호가수량3'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidrem3"))
            #result['매도호가건수3'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offercnt3"))
            #result['매수호가건수3'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidcnt3"))
            #result['매도호가4'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerho4"))
            #result['매수호가4'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidho4"))
            #result['매도호가수량4'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerrem4"))
            #result['매수호가수량4'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidrem4"))
            #result['매도호가건수4'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offercnt4"))
            #result['매수호가건수4'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidcnt4"))
            #result['매도호가5'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerho5"))
            #result['매수호가5'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidho5"))
            #result['매도호가수량5'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerrem5"))
            #result['매수호가수량5'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidrem5"))
            #result['매도호가건수5'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offercnt5"))
            #result['매수호가건수5'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidcnt5"))
...
class OC0(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            ...
            result['미결제약정수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "openyak"))
            #result['KOSPI200지수'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "k200jisu"))
            #result['KOSPI등가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "eqva"))
            #result['이론가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "theoryprice"))
            #result['내재변동성'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "impv"))
            result['미결제약정증감'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "openyakcha"))
            #result['시간가치'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "timevalue"))
            #result['장운영정보'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "jgubun")
            #result['전일동시간대거래량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "jnilvolume"))
...
class EC0(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            ...
            #result['정규장종가대비'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "change"))
            result['정규장종가기준등락율'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "drate"))
            result['현재가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "price"))
            result['시가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "open"))
            result['고가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "high"))
            result['저가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "low"))
            ...
            #result['체결량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "cvolume"))
            result['누적거래량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "volume"))
            #result['누적거래대금(미제공)'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "value"))
            result['매도누적체결량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume"))
            #result['매도누적체결건수(미제공)'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdchecnt"))
            result['매수누적체결량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume"))
            #result['매수누적체결건수(미제공)'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mschecnt"))
            #result['체결강도'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "cpower"))
            #result['매도호가1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerho1"))
            #result['매수호가1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidho1"))
            #result['미결제약정수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "openyak"))
...
class YJ_(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            result = dict()
            result['수신시간'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "time")
            result['예상지수'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "jisu"))
            result['예상전일대비구분'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "sign")
            result['예상전일비'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "change"))
            result['예상등락율'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "drate"))
            result['예상체결량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "cvolume"))
            result['누적거래량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "volume"))
            result['예상거래대금'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "value"))
...
class YFC(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            ...
            result['예상체결가전일종가대비'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "preychange"))
            result['예상체결가전일종가등락율'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "jnilydrate"))
            result['단축코드'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "futcode")
            result['tr_code'] = szTrCode
...
class YS3(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            ...
            result['수신시간'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "hotime")
            result['예상체결가격'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "yeprice"))
            result['예상체결수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "yevolume"))
            result['예상체결가전일종가대비구분'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "jnilysign")
            result['예상체결가전일종가대비'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "preychange"))
            result['예상체결가전일종가등락율'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "jnilydrate"))
            result['예상매도호가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "yofferho0"))
            result['예상매수호가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ybidho0"))
            result['예상매도호가수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "yofferrem0"))
            result['예상매수호가수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ybidrem0"))
            result['단축코드'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "shcode")
            result['tr_code'] = szTrCode
...
class IJ_(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            ...
            result['전일대비구분'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "sign")
            result['전일비'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "change"))
            result['등락율'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "drate"))
            #result['체결량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "cvolume"))
            #result['거래량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "volume"))
            #result['거래대금'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "value"))
            #result['상한종목수'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "upjo"))
            #result['상승종목수'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "highjo"))
            #result['보합종목수'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "unchgjo"))
            #result['하락종목수'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "lowjo"))
            #result['하한종목수'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "downjo"))
            #result['상승종목비율'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "upjrate"))
            ...
            result['저가시간'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "lowtime")
            result['외인순매수수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "frgsvolume"))
            result['기관순매수수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "orgsvolume"))
            result['외인순매수금액'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "frgsvalue"))
            result['기관순매수금액'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "orgsvalue"))
            result['업종코드'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "upcode")
            result['tr_code'] = szTrCode
...
class BMT(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            ...
            result['매수거래량1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume1"))
            result['매도거래량1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume1"))
            result['거래량순매수1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvol1"))
            result['매수거래대금1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvalue1"))
            result['매도거래대금1'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvalue1"))
            ...
            result['매수거래량2'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume2"))
            result['매도거래량2'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume2"))
            result['거래량순매수2'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvol2"))
            result['매수거래대금2'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvalue2"))
            result['매도거래대금2'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvalue2"))
            ...
            result['매수거래량3'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume3"))
            result['매도거래량3'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume3"))
            result['거래량순매수3'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvol3"))
            result['매수거래대금3'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvalue3"))
            result['매도거래대금3'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvalue3"))
            ...
            result['매수거래량4'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume4"))
            result['매도거래량4'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume4"))
            result['거래량순매수4'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvol4"))
            result['매수거래대금4'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvalue4"))
            result['매도거래대금4'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvalue4"))
            ...
            result['매수거래량5'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume5"))
            result['매도거래량5'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume5"))
            result['거래량순매수5'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvol5"))
            result['매수거래대금5'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvalue5"))
            result['매도거래대금5'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvalue5"))
            ...
            result['매수거래량6'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume6"))
            result['매도거래량6'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume6"))
            result['거래량순매수6'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvol6"))
            result['매수거래대금6'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvalue6"))
            result['매도거래대금6'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvalue6"))
            ...
            result['매수거래량7'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume7"))
            result['매도거래량7'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume7"))
            result['거래량순매수7'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvol7"))
            result['매수거래대금7'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvalue7"))
            result['매도거래대금7'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvalue7"))
            ...
            result['매수거래량8'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume8"))
            result['매도거래량8'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume8"))
            result['거래량순매수8'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvol8"))
            result['매수거래대금8'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvalue8"))
            result['매도거래대금8'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvalue8"))
            ...
            result['매수거래량9'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume9"))
            result['매도거래량9'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume9"))
            result['거래량순매수9'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvol9"))
            result['매수거래대금9'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvalue9"))
            result['매도거래대금9'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvalue9"))
            ...
            result['매수거래량10'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume10"))
            result['매도거래량10'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume10"))
            result['거래량순매수10'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvol10"))
            result['매수거래대금10'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvalue10"))
            result['매도거래대금10'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvalue10"))
            ...
            result['매수거래량11'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume11"))
            result['매도거래량11'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume11"))
            result['거래량순매수11'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvol11"))
            result['매수거래대금11'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvalue11"))
            result['매도거래대금11'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvalue11"))
            ...
            result['매수거래량0'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvolume0"))
            result['매도거래량0'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvolume0"))
            result['거래량순매수0'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvol0"))
            result['매수거래대금0'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "msvalue0"))
            result['매도거래대금0'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mdvalue0"))
...
class OVC(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            ...
            result['전일대비'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ydiffpr"))
            result['전일대비기호'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "ydiffSign")
            result['시가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "open"))
            result['고가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "high"))
            result['저가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "low"))
            result['등락율'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "chgrate"))
            #result['건별체결수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "trdq"))
...
class TC1(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        result['주문번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ordr_no"))
        result['원주문번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "orgn_ordr_no"))
        result['모주문번호'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "mthr_ordr_no"))
        ...
        result['주문가격'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ordr_prc"))
        result['주문조건가격'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "cndt_ordr_prc"))
        result['주문수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ordr_q"))
...
class TC2(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        result['주문수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ordr_q"))
        result['주문시간'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "ordr_tm")
        result['호가확인수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "cnfr_q"))
...
class TC3(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        result['매도매수유형'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "s_b_ccd")
        result['정정취소유형'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "ordr_ccd")
        result['체결수량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ccls_q"))
        result['체결가격'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ccls_prc"))
        result['체결번호'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "ccls_no")
        result['체결시간'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "ccls_tm")
        result['매입평균단가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "avg_byng_uprc"))
        result['매입금액'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "byug_amt"))
        result['청산손익'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "clr_pl_amt"))
        result['위탁수수료'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "ent_fee"))
        result['FCM수수료'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "fcm_fee"))
        result['사용자ID'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "userid")
        result['현재가격'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "now_prc"))
...
class MK2(XAReal):
    ...
    def OnReceiveRealData(self, szTrCode):
        ...
        try:
            ...
            result['전일대비구분'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "sign")
            result['전일대비'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "change"))
            result['등락율'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "uprate"))
            result['매수호가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidho"))
            result['매수잔량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "bidrem"))
            result['매도호가'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerho"))
            result['매도잔량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "offerrem"))
            result['누적거래량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "volume"))
            result['심볼'] = self.ActiveX.GetFieldData(self.OUTBLOCK, "xsymbol")
            result['체결거래량'] = (self.ActiveX.GetFieldData(self.OUTBLOCK, "cvolume"))
            result['tr_code'] = szTrCode
