...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(279, 603)
        self.groupBox = QtWidgets.QGroupBox(Dialog)
        self.groupBox.setGeometry(QtCore.QRect(20, 10, 241, 581))
        font = QtGui.QFont()
        ...
        self.widget.setGeometry(QtCore.QRect(10, 30, 210, 541))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_cm_opt_price.setText(_translate("Dialog", "본월물 옵션가격"))
        self.checkBox_cm_opt_quote.setText(_translate("Dialog", "본월물 옵션호가"))
        self.checkBox_cm_opt_quote_1.setText(_translate("Dialog", "본월물 옵션호가(등가중심 10)"))
