...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(10, 31, 271, 22))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_2.setTitle(_translate("Dialog", "실시간 Data 갱신 허용오차"))
        self.label_1.setText(_translate("Dialog", "sec"))
