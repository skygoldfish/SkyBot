        ...
        for i in loop_list:
            ...
            if df_call.iloc[i]['저가'] in 진성맥점:
                ...
                if blink:
                    ...
                    str = '[{0:02d}:{1:02d}:{2:02d}] 콜저가 {3:0.2f} 에서 진성맥점 발생 !!!\r'.format(\
        ...
        for i in loop_list:
            ...
            if df_call.iloc[i]['고가'] in 진성맥점:
                ...
                if blink:
                    ...
                    str = '[{0:02d}:{1:02d}:{2:02d}] 콜고가 {3:0.2f} 에서 진성맥점 발생 !!!\r'.format(\
            ...
            if opt_coreval_search_start_value < df_call.iloc[i]['시가'] < opt_search_end_value:
                ...
                if df_call.iloc[i]['저가'] in coreval:
                    ...
                    if df_call.iloc[i]['저가'] in 진성맥점:
                        ...
                        ToTelegram("콜 저가 {0:.2f}에서 진성맥점이 발생했습니다.".format(df_call.iloc[i]['저가']))
                ...
                if df_call.iloc[i]['고가'] in coreval:
                    ...
                    if df_call.iloc[i]['고가'] in 진성맥점:
                        ...
                        ToTelegram("콜 고가 {0:.2f}에서 진성맥점이 발생했습니다.".format(df_call.iloc[i]['고가']))
        ...
        for i in loop_list:
            ...
            if df_put.iloc[i]['저가'] in 진성맥점:
                ...
                if blink:
                    ...
                    str = '[{0:02d}:{1:02d}:{2:02d}] 풋저가 {3:0.2f} 에서 진성맥점 발생 !!!\r'.format(\
        ...
        for i in loop_list:
            ...
            if df_put.iloc[i]['고가'] in 진성맥점:
                ...
                if blink:
                    ...
                    str = '[{0:02d}:{1:02d}:{2:02d}] 풋고가 {3:0.2f} 에서 진성맥점 발생 !!!\r'.format(\
            ...
            if opt_coreval_search_start_value < df_put.iloc[i]['시가'] < opt_search_end_value:
                ...
                if df_put.iloc[i]['저가'] in coreval:
                    ...
                    if df_put.iloc[i]['저가'] in 진성맥점:
                        ...
                        ToTelegram("풋 저가 {0:.2f}에서 진성맥점이 발생했습니다.".format(df_put.iloc[i]['저가']))   
                ...
                if df_put.iloc[i]['고가'] in coreval:
                    ...
                    if df_put.iloc[i]['고가'] in 진성맥점:
                        ...
                        ToTelegram("풋 고가 {0:.2f}에서 진성맥점이 발생했습니다.".format(df_put.iloc[i]['고가']))
