...
class 화면_당월물옵션전광판(QDialog, Ui_당월물옵션전광판):
    ...
    def _call_horizontal_header_clicked(self, idx):
        ...
        if idx == 3 or idx == 4 or idx == 5 or idx == 6 or idx == 7 or idx == 8 or idx == 9 or idx == 10:
            ...
            # cell focus 이동
            self.tableWidget_call.setCurrentCell(atm_index, 19)
    ...
    def _put_horizontal_header_clicked(self, idx):
        ...
        if idx == 3 or idx == 4 or idx == 5 or idx == 6 or idx == 7 or idx == 8 or idx == 9 or idx == 10:
            ...
            # cell focus 이동
            self.tableWidget_put.setCurrentCell(atm_index, 19)
            self.opt_node_coloring()
        else:
            if idx == 11:
                self.put_open_check()
    ...
    def call_coreval_color_update(self):
        ...
        for i in loop_list:
            ...
            if opt_coreval_search_start_value < df_cm_call.iloc[i]['시가'] < opt_search_end_value:
    ...
    def put_coreval_color_update(self):
        ...
        for i in loop_list:
            ...
            if opt_coreval_search_start_value < df_cm_put.iloc[i]['시가'] < opt_search_end_value:
